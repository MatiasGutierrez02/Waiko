<template>
  <header :class="['header', { 'is-hidden': isHidden }]">
    <div class="container">
      <img src="../assets/LogoFinalIcono.png" class="imagenLogo" alt="Logo" />
...
export default {
  ...
  methods: {
    ...
    handleScroll() {
      ...
      if (this.isMenuOpen) { this.isHidden = false; this.lastY = y; return }
...
.header {
  ...
  transition: transform .35s ease, box-shadow .2s ease, background-color .2s ease;
...
.imagenLogo:hover { transform: scale(1.05); }
...
.hamburger span.open:nth-child(1) { transform: translateY(7.5px) rotate(45deg); }
.hamburger span.open:nth-child(2) { opacity: 0; }
.hamburger span.open:nth-child(3) { transform: translateY(-7.5px) rotate(-45deg); }
